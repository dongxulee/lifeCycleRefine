...
def policy(beta_r,agentType, ga, age, x):
    '''
        Input: beta_r, agentType, gamma
    '''
    # risk tolerance parameter 
    ...
    # return age dependent decicions
    fileName = agentType + "_" + str(beta_r) + "_" + str(gamma)
    Vf = np.load("solution/" + fileName + ".npy", allow_pickle=True)
    return V(age, Vf[:,:,:,:,:,:,age+1], x)   